...
class WidgetApiInteractor extends ApiHelper
{
    ...
    private $styleFnc = 'api/dreamsv2/style';
    ...
    {
        // add on local debug
        //$_SERVER['endpoint_US'] = 'https://dresamsapi.bmby.com/';
        //$_SERVER['categoryid'] = "5f90337efd3312117923af64";
        $this->apiKey = $apiKey;
   ...
   */
    ...
    public function getStyles(){
        return $this->sendRequest($this->styleFnc);
    }
